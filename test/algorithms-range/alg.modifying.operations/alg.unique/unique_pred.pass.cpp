...
test()
{
    ...
    count_equal::count = 0;
    Range r = std::unique(Range(std::make_iter_range(ia, ia+sa)), count_equal());
    ...
    count_equal::count = 0;
    r = std::unique(Range(std::make_iter_range(ib, ib+sb)), count_equal());
    ...
    count_equal::count = 0;
    r = std::unique(Range(std::make_iter_range(ic, ic+sc)), count_equal());
    ...
    count_equal::count = 0;
    r = std::unique(Range(std::make_iter_range(id, id+sd)), count_equal());
    ...
    count_equal::count = 0;
    r = std::unique(Range(std::make_iter_range(ie, ie+se)), count_equal());
    ...
    count_equal::count = 0;
    r = std::unique(Range(std::make_iter_range(ig, ig+sg)), count_equal());
    ...
    count_equal::count = 0;
    r = std::unique(Range(std::make_iter_range(ih, ih+sh)), count_equal());
    ...
    count_equal::count = 0;
    r = std::unique(Range(std::make_iter_range(ii, ii+si)), count_equal());
